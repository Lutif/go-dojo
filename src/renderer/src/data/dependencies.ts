...
export const REQUIRES: Record<string, string[]> = {
  ...
  'proj-kv-01': ['basics_24_maps', 'basics_27_structs'],
  'proj-kv-02': ['proj-kv-01', 'stdlib_02_strings'],
  'proj-kv-03': ['proj-kv-02', 'conc_11_rwmutex'],
  'proj-kv-04': ['proj-kv-03', 'stdlib_20_time_basics'],
  'proj-kv-05': ['proj-kv-04'],
  'proj-kv-06': ['proj-kv-05', 'stdlib_08_os_read'],
  'proj-kv-07': ['proj-kv-06'],
  'proj-kv-08': ['proj-kv-07'],

  // ── Pipeline Framework (6 steps) ───────────────────────────────────────────
  'proj-pipe-01': ['conc_03_channels_basic', 'basics_09_functions'],
  'proj-pipe-02': ['proj-pipe-01'],
  'proj-pipe-03': ['proj-pipe-02', 'errors_01_basics'],
  'proj-pipe-04': ['proj-pipe-03', 'conc_02_waitgroup'],
  'proj-pipe-05': ['proj-pipe-04', 'stdlib_20_time_basics'],
  'proj-pipe-06': ['proj-pipe-05'],

  // ── Connection Pool (6 steps) ──────────────────────────────────────────────
  'proj-pool-01': ['basics_27_structs', 'basics_28_struct_methods'],
  'proj-pool-02': ['proj-pool-01'],
  'proj-pool-03': ['proj-pool-02', 'stdlib_20_time_basics'],
  'proj-pool-04': ['proj-pool-03', 'conc_03_channels_basic'],
  'proj-pool-05': ['proj-pool-04'],
  'proj-pool-06': ['proj-pool-05'],

  // ── Structured Logger (6 steps) ────────────────────────────────────────────
  'proj-log-01': ['basics_27_structs', 'stdlib_20_time_basics'],
  'proj-log-02': ['proj-log-01'],
  'proj-log-03': ['proj-log-02'],
  'proj-log-04': ['proj-log-03', 'conc_11_rwmutex'],
  'proj-log-05': ['proj-log-04', 'stdlib_08_os_read'],
  'proj-log-06': ['proj-log-05'],

  // ── File Watcher (5 steps) ─────────────────────────────────────────────────
  'proj-watcher-01': ['stdlib_08_os_read'],
  'proj-watcher-02': ['proj-watcher-01'],
  'proj-watcher-03': ['proj-watcher-02', 'conc_03_channels_basic'],
  'proj-watcher-04': ['proj-watcher-03'],
  'proj-watcher-05': ['proj-watcher-04', 'conc_11_rwmutex'],

  // ── Git Internals (8 steps) ────────────────────────────────────────────────
  'proj-git-01': ['stdlib_23_crypto_hash'],
  'proj-git-02': ['proj-git-01'],
  'proj-git-03': ['proj-git-02', 'stdlib_08_os_read'],
  'proj-git-04': ['proj-git-03'],
  'proj-git-05': ['proj-git-04', 'stdlib_20_time_basics'],
  'proj-git-06': ['proj-git-05'],
  'proj-git-07': ['proj-git-06'],
  'proj-git-08': ['proj-git-07'],

  // ── Test Framework (6 steps) ───────────────────────────────────────────────
  'proj-test-01': ['basics_27_structs', 'basics_28_struct_methods'],
  'proj-test-02': ['proj-test-01'],
  'proj-test-03': ['proj-test-02', 'stdlib_08_os_read'],
  'proj-test-04': ['proj-test-03'],
  'proj-test-05': ['proj-test-04'],
  'proj-test-06': ['proj-test-05'],
...
const EXERCISE_TITLES: Record<string, string> = {
  ...
  'proj-kv-01': 'KV Store — In-Memory', 'proj-kv-02': 'KV Store — Protocol',
  'proj-kv-03': 'KV Store — Thread-Safe', 'proj-kv-04': 'KV Store — TTL',
  'proj-kv-05': 'KV Store — LRU Eviction', 'proj-kv-06': 'KV Store — Persistence',
  'proj-kv-07': 'KV Store — Transactions', 'proj-kv-08': 'KV Store — Benchmarking',
  'proj-pipe-01': 'Pipeline — Stages', 'proj-pipe-02': 'Pipeline — Transforms',
  'proj-pipe-03': 'Pipeline — Error Handling', 'proj-pipe-04': 'Pipeline — Fan-Out',
  'proj-pipe-05': 'Pipeline — Buffering', 'proj-pipe-06': 'Pipeline — Cancellation',
  'proj-pool-01': 'Pool — Basic Factory', 'proj-pool-02': 'Pool — Health Checks',
  'proj-pool-03': 'Pool — Idle Timeout', 'proj-pool-04': 'Pool — Semaphore Blocking',
  'proj-pool-05': 'Pool — Graceful Drain', 'proj-pool-06': 'Pool — Metrics',
  'proj-log-01': 'Logger — Entries & Levels', 'proj-log-02': 'Logger — Formatted Output',
  'proj-log-03': 'Logger — JSON Output', 'proj-log-04': 'Logger — Thread-Safe',
  'proj-log-05': 'Logger — Log Rotation', 'proj-log-06': 'Logger — Handler Middleware',
  'proj-watcher-01': 'Watcher — File Snapshot', 'proj-watcher-02': 'Watcher — Change Detection',
  'proj-watcher-03': 'Watcher — Polling', 'proj-watcher-04': 'Watcher — Pattern Filtering',
  'proj-watcher-05': 'Watcher — Debounced Events',
  'proj-git-01': 'Git — Content Hashing', 'proj-git-02': 'Git — Object Store',
  'proj-git-03': 'Git — Disk Store', 'proj-git-04': 'Git — Tree Objects',
  'proj-git-05': 'Git — Commit Objects', 'proj-git-06': 'Git — References',
  'proj-git-07': 'Git — Log Traversal', 'proj-git-08': 'Git — Diff',
  'proj-test-01': 'Test — Custom Assertions', 'proj-test-02': 'Test — Table-Driven Runner',
  'proj-test-03': 'Test — Golden Files', 'proj-test-04': 'Test — Fixtures',
  'proj-test-05': 'Test — Benchmarks', 'proj-test-06': 'Test — Fuzz Helpers',

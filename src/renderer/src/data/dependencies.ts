...
export const REQUIRES: Record<string, string[]> = {
  ...
  'basics_24_slice_operations':     ['basics_23_slices'],
  'basics_25_maps':                 ['basics_09_functions'],
  'basics_26_map_operations':       ['basics_25_maps'],
  ...
  'types_04_empty_interface':        ['types_01_interfaces'],
  'types_05_type_assertions':        ['types_04_empty_interface'],
  'types_06_type_switch':            ['types_05_type_assertions'],
  ...
  'types_11_generic_functions':      ['basics_09_functions'],
  ...
  'errors_11_defer_cleanup': ['errors_09_defer_basics'],
  'errors_12_strategies':   ['errors_04_is', 'errors_05_as'],
  'errors_13_must':         ['errors_07_panic', 'errors_08_recover'],
  'errors_14_multi_error':  ['errors_03_wrapping'],
  'errors_15_hierarchy':    ['errors_02_custom', 'types_05_type_assertions'],
  ...
  'conc_09_select_timeout':   ['conc_07_select_basic'],
  ...
  'conc_16_context_timeout':  ['conc_15_context_cancel'],
  ...
  'conc_23_rate_limiter':     ['conc_22_semaphore'],
  'conc_24_errgroup':         ['conc_02_waitgroup', 'errors_01_basics'],
  'conc_25_graceful_shutdown':['conc_14_context_basic', 'conc_07_select_basic'],
  ...
  'stdlib_08_os_read':      ['stdlib_05_io_reader'],
  ...
  'stdlib_14_http_client':    ['stdlib_05_io_reader', 'errors_01_basics'],
  ...
  'stdlib_20_time_basics':    ['basics_02_variables'],
  'stdlib_21_time_ticker':    ['stdlib_20_time_basics', 'conc_03_channels_basic'],
  'stdlib_22_math_rand':      ['basics_02_variables'],
  ...
  'patterns_15_pubsub':              ['conc_05_channel_direction', 'types_01_interfaces'],
  'patterns_16_circuit_breaker':     ['errors_01_basics', 'conc_10_mutex'],
  'patterns_17_retry_backoff':       ['errors_01_basics', 'stdlib_20_time_basics'],
  'patterns_18_graceful_shutdown':   ['conc_25_graceful_shutdown'],
  'patterns_19_config_loading':      ['stdlib_11_json_marshal', 'stdlib_08_os_read'],
  ...
  'patterns_23_state_machine':       ['basics_14_switch'],
  'patterns_24_pool':                ['conc_11_rwmutex', 'basics_23_slices'],
  'patterns_25_registry':            ['basics_25_maps', 'types_01_interfaces'],
  ...
  'internals_12_reflect_basics':     ['types_05_type_assertions'],
  ...
  'internals_15_build_tags':         ['basics_01_hello'],
  'internals_16_code_generation':    ['basics_09_functions'],
  'internals_17_linker_flags':       ['basics_01_hello'],
  'internals_18_race_detection':     ['conc_10_mutex'],
  'internals_19_compiler_directives':['basics_09_functions'],
  'internals_20_runtime_info':       ['conc_01_goroutines'],
  ...
  'net_01_tcp_server':          ['conc_01_goroutines', 'errors_01_basics'],
  ...
  'net_05_http_client':         ['stdlib_14_http_client'],
  'net_06_connection_pool':     ['patterns_24_pool'],
  'net_07_rate_limiter':        ['conc_23_rate_limiter', 'net_02_http_handler'],
  'net_08_load_balancer':       ['net_01_tcp_server'],
  ...
  'net_13_service_discovery':   ['net_01_tcp_server', 'basics_25_maps'],
  'net_14_health_check':        ['net_02_http_handler'],
  'net_15_circuit_breaker_http':['patterns_16_circuit_breaker', 'net_02_http_handler'],
  ...
  'data_01_kv_store':          ['conc_11_rwmutex', 'basics_25_maps'],
  'data_02_kv_ttl':            ['data_01_kv_store', 'stdlib_20_time_basics'],
  'data_03_lru_cache':         ['data_01_kv_store', 'basics_25_maps'],
  ...
  'data_08_consistent_hashing':['basics_23_slices', 'stdlib_04_sort'],
  'data_09_event_store':       ['conc_11_rwmutex', 'basics_23_slices'],
  'data_10_merkle_tree':       ['stdlib_23_crypto_hash', 'basics_27_structs'],
  'data_11_generic_pool':      ['types_11_generic_functions', 'conc_10_mutex'],
  'data_12_query_engine':      ['basics_23_slices', 'basics_25_maps'],
  'data_13_transaction_log':   ['data_07_wal'],
  'data_14_inverted_index':    ['basics_25_maps', 'stdlib_02_strings'],
  'data_15_column_store':      ['data_12_query_engine'],

  // ── Projects ─────────────────────────────────────────────────────────────
  'proj-cli-01': ['basics_16_for_loop', 'stdlib_02_strings'],
  ...
  'proj-queue-01': ['errors_01_basics', 'basics_09_functions'],
  ...
  'proj-kv-01': ['conc_11_rwmutex', 'basics_25_maps'],
  ...
  'proj-container-01': ['basics_27_structs', 'basics_25_maps'],
  ...
  'proj-monkey-01': ['basics_16_for_loop', 'basics_07_basic_types'],
  ...
  'proj-monkey-20': ['proj-monkey-19', 'basics_25_maps'],
...
const EXERCISE_TITLES: Record<string, string> = {
  ...
  'basics_23_slices': 'Slices', 'basics_24_slice_operations': 'Slice Operations',
  'basics_25_maps': 'Maps', 'basics_26_map_operations': 'Map Operations',
  ...
  'types_03_interface_composition': 'Interface Composition', 'types_04_empty_interface': 'Empty Interface',
  'types_05_type_assertions': 'Type Assertions', 'types_06_type_switch': 'Type Switch',
...
export const PREREQ_HINTS: Record<string, Array<{ text: string; exerciseId: string; exerciseTitle: string }>> = {
  ...
  'proj-sub-01': [
    { text: "Store handlers in a map[string]HandlerFn — see Maps.", exerciseId: 'basics_25_maps', exerciseTitle: 'Maps' },
  ...
  'proj-rest-01': [
    ...
    { text: "Map operations for get/set/delete — see Map Operations.", exerciseId: 'basics_26_map_operations', exerciseTitle: 'Map Operations' },
  ],
  'proj-rest-02': [
  ...
  'proj-kv-01': [
    { text: "Store data in map[string]string — see Maps.", exerciseId: 'basics_25_maps', exerciseTitle: 'Maps' },
  ...
  'proj-git-02': [
    { text: "A ref is a named pointer to a hash — store in map[string]string — see Maps.", exerciseId: 'basics_25_maps', exerciseTitle: 'Maps' },
  ],
  'proj-git-03': [
  ...
  'proj-container-01': [
    { text: "A namespace holds a map of processes — see Maps.", exerciseId: 'basics_25_maps', exerciseTitle: 'Maps' },
  ],
  'proj-container-02': [
  ...
  'proj-monkey-04': [
    { text: "Use a map to lookup keywords — see Maps.", exerciseId: 'basics_25_maps', exerciseTitle: 'Maps' },
  ],
  'proj-monkey-05': [
  ...
  'proj-monkey-20': [
    { text: "Environment is map[string]Object — stores variable bindings.", exerciseId: 'basics_25_maps', exerciseTitle: 'Maps' },
  ],
  'proj-monkey-21': [
